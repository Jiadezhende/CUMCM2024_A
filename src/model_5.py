...
class Model_5:
    ...
    def __init__(self,num, head_length, body_length, distance, extension, width,r,k):
        ...
        self.__private_AB()
        print(f"Model_5 initialized with alpha={self.alpha:.4f}, r_A={self.r_A:.4f}, r_B={self.r_B:.4f}")
    ...
    def trace_period(self, min_time, max_time, v, acc=0.01,step=0.01, output_dir="../data/output"):
        """
        ...
        pos_file = os.path.join(output_dir, f"q5_positions_{timestamp}.xlsx")
        vel_file = os.path.join(output_dir, f"q5_velocities_{timestamp}.xlsx")
